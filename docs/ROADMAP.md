...
> 状态:P4-1(消息队列)、P4-2(@文件引用+Tab 补全)、P4-3(代码块高亮)、P4-4(会话命名)、P4-5(C6 多级上下文)、P4-6(多行输入/外部编辑器)、P4-7(工具视觉增强)、P4-8(/compact 手动压缩)、P4-9(语义色 token 化)✅ 已交付,其余 ⏳ 未实施。排期原则:用户可感 > 依赖 M7 > 成本。Agent 能力面无缺口
