...
> **当前未实施清单:IM 远程控制线(P0–P3,2026-10-03 登记,规划正文见 docs/IM_REMOTE.md;P0-1/P0-2a/P0-2b(微信 ilink 文本闭环,含终端二维码直显)+ P0-2b-QQ(T1–T5:协议壳/插件壳文本闭环/typing 分块 markdown/文字 y·n 审批/时效·主动配额)+ **P1 会话绑定命令面(2026-10-10,见下行)** 已交付 ✅,见下;剩余 P0-2c 媒体 CDN、QQ T6(命令面授权持久基本随 T1–T5 完成、真机清单待人工)、P2 可靠投递、P3 三端融合(含 web/桌面 IM 面板 + QQ 键盘 confirm + confirm 事件化)与 §6.1 出站预算层)**。
