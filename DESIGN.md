...
>
> **当前未实施清单(3 项)**:M7 Web UI · M7.2 UI 槽位插件化 · M7.3 WebSocket 通道 —— 见下方各 ⏳ 行。M6.1–M6.21、M8、M10 已交付 ✅;M9.1(one-shot)与 M11-T1(规划输出+确认门)于 2025-09 迭代交付 ✅(细表见下方 M9/M11 行正文开头「交付(T1)」)。P1 剩余:S2.2 折叠交互随 S2.2;M9.2/M11-T2 已交付 ✅(2025-09,细表见下方 M9/M11 行)。
>
