...
> **当前未实施清单:IM 远程控制线(P0–P3,2026-10-03 登记,规划正文见 docs/IM_REMOTE.md;P0-1/P0-2a/P0-2b(微信 ilink 文本闭环,含终端二维码直显)+ P0-2b-QQ(T1–T4:协议壳/插件壳文本闭环/typing 分块 markdown/文字 y·n 审批)已交付 ✅,见下;剩余 P0-2c 媒体 CDN、QQ T6、P1–P3(含 web/桌面三端融合 + QQ 键盘 confirm + 长回合 job 化))**。
