...
>
> **体验改进排期(对比 pi,非里程碑)**:12 项已入 `docs/ROADMAP.md` P4 节(来源 `docs/PI_COMPARISON.md`;T1 消息队列/@引用/代码块高亮等,均未开工;P4-4 C3 会话命名与 P4-9 E2 语义色 token 化已交付 ✅(2025-10,见 docs/ROADMAP.md P4 节))。
>
