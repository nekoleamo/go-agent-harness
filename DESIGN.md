...
### S 组 · 三端优化(P0–P2,2026-09-18 登记)

> **来源**:三端(TUI / Web / 桌面壳)与 **dsh**、**Codex CLI+App**、**Hermes Agent**、**OpenClaw** 对标研究(2026-09-18 快照)。
