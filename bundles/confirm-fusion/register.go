// Package confirmfusion 是 confirm-fusion bundle 的插件装配层(P3 三端融合):
// host-confirm-fusion 统一 ctx.confirm 仲裁,使 web/im 等 UI 通道同进程并存。
// 融合 profile(bundles: base, confirm-fusion, web, im-qq)装配本层;web/im 检测到
