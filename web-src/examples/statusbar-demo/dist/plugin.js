...
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), we = (e) => e.startsWith("onUpdate:"), H = Object.assign, m = Array.isArray, w = (e) => typeof e == "function", y = (e) => typeof e == "string", Oe = (e) => typeof e == "symbol", N = (e) => e !== null && typeof e == "object";
let ee;
...
function b(e, ...t) {
  if (L) return;
  L = !0;
  const n = S.length ? S[S.length - 1].component : null, o = n && n.appContext.config.warnHandler, s = Te();
  if (o)
    X(
      o,
      n,
...
function re(e, t, n) {
  return y(t) ? (t = JSON.stringify(t), n ? t : [`${e}=${t}`]) : typeof t == "number" || typeof t == "boolean" || t == null ? n ? t : [`${e}=${t}`] : /* @__PURE__ */ Q(t) ? (t = re(e, /* @__PURE__ */ O(t.value), !0), n ? t : [`${e}=Ref<`, t, ">"]) : w(t) ? [`${e}=fn${t.name ? `<${t.name}>` : ""}`] : (t = /* @__PURE__ */ O(t), n ? t : [`${e}=`, t]);
}
const se = {
...
function $e(e, t, n, o = !0, s = !1) {
  if (process.env.NODE_ENV !== "production") {
    const r = se[t];
    if (n && Re(n), b(`Unhandled error${r ? ` during execution of ${r}` : ""}`), n && De(), o)
      throw e;
    console.error(e);
  } else {
    if (s)
...
function He(e) {
  if (!(e.flags & 1)) {
    const t = T(e), n = d[d.length - 1];
    !n || // fast path when the job id is larger than the tail
    !(e.flags & 2) && t >= T(n) ? d.push(e) : d.splice(Me(t), 0, e), e.flags |= 1, le();
  }
}
function le() {
  q || (q = Ae.then(ce));
...
process.env.NODE_ENV !== "production" && (Ye.ownKeys = (e) => (b(
...
const Ze = (...e) => _e(
  ...
  ref_key: t,
  ref_for: n
}) => (typeof e == "number" && (e = "" + e), e != null ? y(e) || /* @__PURE__ */ Q(e) || w(e) ? { i: A, r: e, k: t, f: !!n } : e : null);
function et(e, t = null, n = null, o = 0, s = null, r = e === de ? 0 : 1, l = !1, c = !1) {
  ...
  if (c ? (M(a, n), r & 128 && e.normalize(a)) : n && (a.shapeFlag |= y(n) ? 8 : 16), process.env.NODE_ENV !== "production" && a.key !== a.key && b("VNode created with invalid key (NaN). VNode type:", a.type), process.env.NODE_ENV !== "production" && t && a.shapeFlag & 1) {
...
const D = process.env.NODE_ENV !== "production" ? Ze : _e;
function _e(e, t = null, n = null, o = 0, s = null, r = !1) {
  if ((!e || e === Be) && (process.env.NODE_ENV !== "production" && !e && b(`Invalid vnode type when creating vnode: ${e}.`), e = me), B(e)) {
    const c = P(
      e,
      t,
      !0
  ...
  const l = y(e) ? 1 : Qe(e) ? 128 : Z(e) ? 64 : N(e) ? 4 : w(e) ? 2 : 0;
  return process.env.NODE_ENV !== "production" && l & 4 && /* @__PURE__ */ W(e) && (e = /* @__PURE__ */ O(e), b(
...
function lt(e, t, n) {
  try {
    ...
    return o === 2 ? N(t) && !m(t) ? B(t) ? D(e, null, [t]) : D(e, t) : D(e, null, t) : (o > 3 ? n = Array.prototype.slice.call(arguments, 2) : o === 3 && B(n) && (n = [n]), D(e, t, n));
  } finally {
  }
}
function ct() {
...
const ut = {
  ...
  render() {
    ...
    return lt(
      ...
      {
        style: {
          background: e.running ? "#d4a25c" : "#2a2e36",
          color: "#0c1015",
          padding: "1px 8px",
          borderRadius: "10px",
          fontWeight: 600,
